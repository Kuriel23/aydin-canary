...
module.exports = {
  ...
  run: async (interaction, client) => {
    ...
    const avatar = await Canvas.loadImage('https://i.imgur.com/TQmLGI9.png')
    const badge = await Canvas.loadImage('https://i.imgur.com/4yrOIfA.png')
    ...
    const analisar = interaction.options.get('mensagem').value
    let text

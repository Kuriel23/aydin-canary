  ...
  run: async (interaction, client) => {
    return interaction.reply({
      embeds: [new discord.MessageEmbed()
        .setAuthor({ name: '» Botinfo', iconURL: 'https://i.imgur.com/wRtdcZs.png' })
        ...
        .addField('<:db:960637784530489404> Banco de dados:', 'Mongoose', true)
        .addField('<:code:960638489903378432> Desenvolvido em:', '<t:1593105360:f>', true)
        .setColor(client.cor)]
    })
  }
}

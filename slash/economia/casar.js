  ...
  run: async (interaction, client) => {
    ...
    client.db.Users.findOne(
      ...
      function (err, doc) {
        ...
        let autocasar = new discord.MessageEmbed()
          .setAuthor({
        ...
        interaction
          .editReply({ content: null, embeds: [AjudaPrincipal], components: [botao] })
            const filter = i => i.customId === 'primary' && i.user.id === repUser.id;
            ...
            collector.on('collect', async i => {
                if (doc) {
                  ...
                  let aceite = new discord.MessageEmbed()
                    .setAuthor({
                      name:
                        "» " +
                        interaction.member.user.tag +
